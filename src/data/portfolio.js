...
export const projects = [
  {
    title: "Shree Sai Web App",
    description:
      "A JavaScript-heavy web app with a structured frontend workspace, PocketBase files, migrations, hooks, and product/category data flow.",
    tech: ["JavaScript", "PocketBase", "CSS", "HTML", "Shell"],
    github: "https://github.com/balaji3245/shreesai",
    live: "",
    category: "web app",
    accent: "from-cyan-300 via-blue-400 to-violet-400",
  },
  {
    title: "JSPM College Website",
    description:
      "A React and Vite college website with component-based sections for courses, gallery, notices, facilities, contact, and page interactions.",
    tech: ["React", "Vite", "JavaScript", "CSS"],
    github: "https://github.com/balaji3245/JSPM",
    live: "",
    category: "web app",
  ...
  },
  {
    ...
    description:
      "A TypeScript-first Tailwind bundle organized around reusable sections, asset structure, and production-style landing page templates.",
  ...
  },
  {
    title: "FoodMart",
    description:
      "A large food and grocery storefront interface with responsive HTML sections, custom CSS, visual assets, and JavaScript enhancements.",
    tech: ["HTML", "CSS", "JavaScript", "Storefront UI"],
    github: "https://github.com/balaji3245/FoodMart",
    live: "",
    category: "ecommerce UI",
    accent: "from-blue-300 via-cyan-300 to-violet-300",
  },
  {
    title: "School Management System",
    description:
      "A multi-page school management dashboard with attendance, classes, fees, messages, settings, students, teachers, and timetable screens.",
    tech: ["HTML", "JavaScript", "CSS", "Dashboard UI"],
    github: "https://github.com/balaji3245/School-management-system-",
    live: "",
    category: "dashboard",
  ...
  },
  {
    title: "BrandX Info",
    description:
      "A recent brand information website with clean static structure, focused pages, custom styling, and lightweight JavaScript behavior.",
    tech: ["HTML", "CSS", "JavaScript"],
    github: "https://github.com/balaji3245/brandx-info",
    live: "",
    category: "brand site",
    accent: "from-slate-300 via-sky-300 to-cyan-300",
  },
];
