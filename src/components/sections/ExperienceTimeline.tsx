              ...
              <div>
                ...
                <div className="mb-2.5">
                  <div className="flex items-center justify-between gap-2 mb-1.5">
                    <span className="inline-block px-2 py-0.5 rounded-full text-[9px] font-mono font-semibold bg-muted text-foreground border border-border/50">
                      {exp.type}
                    </span>
                    <div className="text-[10px] font-mono text-muted-foreground bg-muted/60 px-2 py-0.5 rounded-md border border-border/50 whitespace-nowrap">
                      {exp.period}
                    </div>
                  </div>

                  <h3 className="text-xs sm:text-base font-bold text-foreground tracking-tight leading-snug whitespace-nowrap overflow-hidden text-ellipsis sm:whitespace-normal">
                    {exp.role}
                  </h3>
                  <div className="text-[11px] sm:text-xs font-semibold text-muted-foreground mt-0.5">
                    {exp.company}
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="flex items-center justify-between pt-2 border-t border-border/40">
                  <button
                    ...
                    className="inline-flex items-center gap-1 text-[11px] font-semibold text-foreground hover:text-blue-500 transition-colors"
                  >
                    <span>Know More</span>
